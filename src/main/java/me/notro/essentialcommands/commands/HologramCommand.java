...
public class HologramCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 2) {
            player.sendMessage(MessageUtility.fixColor("&7(Silent) &cUsage&7: &b/hologram <player> <text>"));
            return false;
        }
        ...
        switch (args[1].toLowerCase()) {
            ...
            default -> player.sendMessage(MessageUtility.fixColor("&7(Silent) &cUsage&7: &b/hologram <player> <text>"));
        }
        return true;
    }
}
